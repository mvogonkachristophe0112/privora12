...
-- CreateIndex
CREATE INDEX "FileShare_senderId_idx" ON "FileShare"("senderId");

-- CreateIndex
CREATE INDEX "FileShare_receiverId_idx" ON "FileShare"("receiverId");

-- CreateIndex
CREATE INDEX "FileShare_receiverEmail_idx" ON "FileShare"("receiverEmail");
...
-- AddForeignKey
ALTER TABLE "FileShare" ADD CONSTRAINT "FileShare_senderId_fkey" FOREIGN KEY ("senderId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "FileShare" ADD CONSTRAINT "FileShare_receiverId_fkey" FOREIGN KEY ("receiverId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
